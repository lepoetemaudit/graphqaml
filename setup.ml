...
(* OASIS_START *)
(* DO NOT EDIT (digest: 312bb083867d8f5076b604172fe77711) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_parsing", []))];
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "Graphqaml";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "gql_gen.ml"});
               Executable
                 ({
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "test_parsing"]
                   })
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "&\135\195\175\nGC\187<\028\006\219\173\226\001\217";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
